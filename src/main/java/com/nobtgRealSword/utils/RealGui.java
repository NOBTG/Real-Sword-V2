...
@OnlyIn(Dist.CLIENT)
public final class RealGui extends Gui {
    ...
    public RealGui(Minecraft p_232355_, ItemRenderer p_232356_) {
    ...
    public void displayScoreboardSidebar(GuiGraphics p_282008_, Objective p_283455_) {
        ...
        List<Score> list = collection.stream().filter((p_93027_) -> p_93027_.getOwner() != null && !p_93027_.getOwner().startsWith("#")).collect(Collectors.toList());
        if (list.size() > 15) {
